...
class CustomUserModel(AbstractBaseUser, PermissionsMixin):
    ...
    is_email_verified = models.BooleanField(default=False) # For the Kid (email path)
    is_phone_verified = models.BooleanField(default=False) # For the Kid (phone path)
    is_parent_approved = models.BooleanField(default=False) # For the Parent

    # We will reuse this field for OTPs (email-based flows only; Twilio handles phone OTPs)
